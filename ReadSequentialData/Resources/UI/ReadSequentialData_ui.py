...
class Ui_ReadSequentialData(object):
    def setupUi(self, ReadSequentialData):
        ...
        ReadSequentialData.resize(318, 499)
        ...
        self.checkBox_flip = QtWidgets.QCheckBox(self.frame_5)
        self.checkBox_flip.setObjectName("checkBox_flip")
        self.horizontalLayout_2.addWidget(self.checkBox_flip)
        self.pushButton_USSeq = QtWidgets.QPushButton(self.frame_5)
        self.pushButton_USSeq.setObjectName("pushButton_USSeq")
        self.horizontalLayout_2.addWidget(self.pushButton_USSeq)
    ...
    def retranslateUi(self, ReadSequentialData):
        ...
        self.checkBox_flip.setText(_translate("ReadSequentialData", "Flip"))
